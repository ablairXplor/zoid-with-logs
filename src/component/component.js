/* @flow */
/* eslint max-lines: 0 */
/* eslint-disable no-console, import/no-unresolved, no-undef */
...
export function component<P, X, C>(
  ...
  const init = (
    ...
    console.log("[ZOID] Initializing component:", tag);
...
/* eslint-enable no-console, import/no-unresolved, no-undef */
